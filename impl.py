...
class CollectionProcessor(Processor):
    ...
    def uploadData(self, path: str):
        try:
            base_url = "https://https://github.com/Atousa95/data-science/" 
            new_graph = Graph()
...
class TriplestoreQueryProcessor(QueryProcessor):
    SPARQL_PREFIXES = """
        ...
        PREFIX ds: <https://https://github.com/Atousa95/data-science/>
    ...
    def getCanvasesInCollection(self, collection_id):
        ...
        query_CanvasInCollection = f"""
            ...
            SELECT ?id ?label
            WHERE {{
                ?collection_id rdf:type ds:Collection ;
                    ds:items ?manifest_id .
                ?manifest_id rdf:type ds:Manifest ;
                    ds:items ?Canvas .
    ...
    def getCollectionsContainingCanvases(self, canvas_id):
        ...
        query_getCollectionsContainingCanvases = f"""
            ...
            SELECT ?id ?label
            WHERE {{
                ?collection rdf:type ds:Collection ;
                            schema:identifier ?id ;
                            rdfs:label ?label ;
                            ds:items ?manifest .
                ?manifest rdf:type ds:Manifest ;
                          ds:items ?canvas_id .
    ...
    def getEntitiesWithType(self, entity_type):
        ...
        query = f"""
            ...
            SELECT ?id ?label
            WHERE {{
                ?entity rdf:type ds:{entity_type.capitalize()} .
                ?entity schema:identifier ?id .
                ?entity rdfs:label ?label .
...
class GenericQueryProcessor(QueryProcessor):
    ...
    def convert_triple(self, dataframe):
        match_types = {
            "https://https://github.com/Atousa95/data-science/Canvas": Canvas,
            "https://https://github.com/Atousa95/data-science/Collection": Collection,
            "https://https://github.com/Atousa95/data-science/Manifest": Manifest
        }
